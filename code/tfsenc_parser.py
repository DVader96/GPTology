...
def parse_arguments():
    ...
    group.add_argument('--sig_elec_file', nargs='?', type=str, default=None)
    ...
    parser.add_argument('--avg_electrodes', action='store_true', default=False)
    parser.add_argument('--use_pred', action='store_true', default=False)
    parser.add_argument('--regr_out', action='store_true', default=False)
    parser.add_argument('--layer_idx', type=int, default=1)
    parser.add_argument('--sig_elec_file2', type = str, default=None)
    parser.add_argument('--prev_paper_test', action='store_true',default=False)
    parser.add_argument('--part-of-model', type = str, default=None)
